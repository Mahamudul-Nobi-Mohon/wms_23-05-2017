       ...
       int PaymentType = 0;
           ...
           if(textBoxInvoiceTotalAmount.Text == "")
            ...
            else
            {
                ...
                if (checkBoxSalesWithoutPrint.Checked == false)
                {
                 ...
                 SerialNo = "";
                 //Temp_Sales_Truncate();
                 textBoxRemarks.Text = textBoxPurchaseBy.Text = textBoxPruchaseByContact.Text = textBoxCustomerName.Text = textBoxGroupName.Text = textBoxCompanyAddress.Text = textBoxVatRegNo.Text = textBoxReference.Text = textBoxPdoductID.Text = textBoxProductCategory.Text = string.Empty;
        ...
        private void dataGridViewSales_DoubleClick_1(object sender, EventArgs e)
        {
            ...
            while (reader1211.Read())
            {
                ...
                textBoxProductCategory.Text= reader1211["Code"].ToString();
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlConnection connection1 = new SqlConnection(conStr);
                string query1 = "UPDATE TempSales SET TempSalesQuantity = '" + textBoxQuantity.Text + "', TempSalesTotal = '" + total + "'  WHERE TempSalesProductID = '" + textBoxPdoductID.Text + "' AND TempSalesCompanyID='"+CompanyID+"'";
                SqlCommand command1 = new SqlCommand(query1, connection1);
                connection1.Open();
                ...
                textBoxQuantity.Text = textBoxProductName.Text = textBoxProductCategory.Text = textBoxPdoductID.Text = textBoxUnitType.Text = "";
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //DataGrid();
                SeeTotal_Component();
                textBoxProductCategory.Text = textBoxProductName.Text = textBoxQuantity.Text = textBoxUnitType.Text = textBoxPdoductID.Text = "";
            }
            catch (Exception)
            {
                MessageBox.Show("Please Select a Product in DataGrid...");
